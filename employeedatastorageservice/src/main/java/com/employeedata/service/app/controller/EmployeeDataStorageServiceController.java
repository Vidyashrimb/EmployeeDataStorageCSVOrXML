...
public class EmployeeDataStorageServiceController {
  ...
  public ResponseEntity<Object> getEmployeeData(@PathVariable String empName, @PathVariable String fileType) {
    logger.trace("Enter inside :getEmployeeData");
    ResponseEntity<Object> responseEntity = employeeDataStorageService.getEmployeeData(empName, fileType);
