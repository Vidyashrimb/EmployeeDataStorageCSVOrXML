...
public abstract class AbstractController {
  ...
  public ResponseEntity<String> handleThrowable(final Throwable ex) {
    logger.trace("{} Enter inside :handleThrowable", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);

    logger.error("{} Exception :handleThrowable {}", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR, ex);
    ...
    logger.trace("{} Exit from :handleThrowable", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);
  ...
  public ResponseEntity<String> handleNoHandlerFoundException(NoHandlerFoundException ex) {
    logger.trace("{} Enter inside :handleNoHandlerFoundException",
        EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);

    logger.error("{} Exception :handleNoHandlerFoundException {}",
        EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR, ex);
    ...
    logger.trace("{} Exit from :handleNoHandlerFoundException", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);
  ...
  public ResponseEntity<String> handleTypeMismatchException(TypeMismatchException ex) {
    ...
    logger.error("{} Exception :handleTypeMismatchException {}", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR,
        ex);
    ...
    logger.trace("{} Exit from :handleTypeMismatchException", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);
  ...
  public ResponseEntity<String> handleException(Exception ex) {
    logger.trace("{} Enter inside :handleException", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);

    logger.error("{} Exception :handleException {}", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR, ex);
    ...
    logger.trace("{} Exit from :handleException", EmployeeDataConstants.LOG_PREFIX_EMPLOYEE_DATA_SERVICE_PROCESSOR);
